...
workflow {
    ...
    def input = []
                ...
                input[0] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile-data_numeric_ids.tsv"])
                input[1] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile-data_numeric_ids-ref.tsv"])
