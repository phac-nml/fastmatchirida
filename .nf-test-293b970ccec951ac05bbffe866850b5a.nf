...
workflow {
    ...
    def input = []
                ...
                input[0] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile-data_numeric_ids_string_loci.tsv"])
                input[1] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile-data_numeric_ids_string_loci-ref.tsv"])
