...
workflow {
    ...
    def input = []
                ...
                input[0] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile_hash_query.tsv"])
                input[1] = Channel.of(
                    ["/home/CSCScience.ca/ssutcliffe/1_pipelinetesting/fastmatchirida/tests/data/profiles/input-profile_hash_ref.tsv"])
                input[2] = Channel.value("pairwise")
                input[3] = []
                input[4] = []
